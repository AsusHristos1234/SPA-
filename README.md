...
- Фильтр по категориям на отдельной странице списка: категории собираются автоматически, выбрать нужную можно в левом блоке.
...
3. Браузер откроет новую вкладку с блоками отслеживаемых товаров: карточки автоматически раскладываются по несколько колонок (на широком экране помещается до пяти) и выглядят так же, как во всплывающем окне. Слева находится панель категорий — нажмите на нужную, чтобы увидеть только товары из выбранного раздела. Здесь доступны те же действия: можно изменить порог уведомления, открыть карточку на Ozon, обновить цены и удалить позиции.
